...
export const metadata: Metadata = {
  ...
  description: 'Portails aluminium battants, coulissants et autoportants a Neuville-sur-Saône. Expert local depuis 2015, fabrication francaise, garantie 10 ans. Devis gratuit.',
...
export default function PortailPage() {
  return (
    <ProductTemplate
      ...
      description="THERA Fermetures concoit et installe des portails aluminium sur mesure a Neuville-sur-Saône depuis 2015. Chaque portail est fabrique en France avec de l'aluminium extrade premium et livre cles en main avec motorisation optionnelle Somfy ou BFT. Plus de 300 coloris disponibles pour s'adapter a votre architecture."
      ...
      structuredData={{
        ...
        description: 'Specialiste portails aluminium a Neuville-sur-Saône depuis 2015.',
