...
export const metadata: Metadata = {
  title: 'Entreprise Portail Aluminium Neuville-sur-Saône — Installateur Local | THERA Fermetures',
  description: 'Portails aluminium Neuville-sur-Saône par THERA Fermetures. Installateur local Val de Saône, motorisation, +300 coloris. Devis gratuit.',
  keywords: ['portail aluminium Neuville-sur-Saône', 'portail coulissant Neuville-sur-Saône', 'portail sur mesure Rhône (69)'],
  alternates: { canonical: 'https://thera-fermetures.fr/portail-aluminium-sur-mesure-neuville-sur-saone' },
  openGraph: {
    title: 'Portail Aluminium sur Mesure Neuville-sur-Saône — THERA Fermetures',
    description: 'Portails aluminium sur mesure a Neuville-sur-Saône. Devis gratuit.',
    images: [{ url: '/images/portails/portail-arnas.jpg', width: 1200, height: 630, alt: 'Portail aluminium Neuville-sur-Saône' }],
  },
}
...
export default function PortailPage() {
  return (
    <ProductTemplate
      title="Portails Aluminium a Neuville-sur-Saône"
      subtitle="Coulissants, battants ou autoportants — installation sur mesure dans la region Val de Saône (69)"
      description="Ville du Val de Saône aux portes de Lyon, Neuville-sur-Saône présente un tissu pavillonnaire dense où la sécurisation des entrées est une priorité. THERA Fermetures y installe des portails aluminium motorisés sur mesure, combinant sécurité et design. Notre équipe intervient régulièrement dans le secteur et connaît les contraintes spécifiques des entrées en pente ou avec caniveaux."
      heroImage="/images/portails/portail-arnas.jpg"
      heroImageAlt="Portail aluminium coulissant sur mesure a Neuville-sur-Saône par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "Le portail coulissant s'ouvre en glissant lateralement. Ideal pour les entrees etroites ou les allees en pente, il est disponible sur rail ou autoportant. Solution robuste pour les proprietes de Neuville-sur-Saône.",
          specs: [
        ...
        },
        {
          ...
          description: "Le portail battant s'ouvre comme une porte classique, en 1 ou 2 vantaux. Elegant et intemporel, il s'adapte parfaitement a tous les styles architecturaux. Motorisation totalement invisible. Tres apprecie des proprietaires de Neuville-sur-Saône.",
          specs: [
      ...
      seoText="Entreprise Thera Fermetures : vente et installation de portail aluminium sur mesure à Neuville-sur-Saône et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
      heroH1="Vente et installation de portails aluminium moderne et sur mesure à Neuville-sur-Saône"
      ctaText="Obtenir mon devis portail a Neuville-sur-Saône"
      structuredData={{
        '@context': 'https://schema.org',
        '@type': 'LocalBusiness',
        name: 'THERA Fermetures',
        description: 'Installateur de portails aluminium sur mesure à Neuville-sur-Saône. Coulissant, battant, autoportant. Devis gratuit.',
        url: 'https://thera-fermetures.fr/portail-aluminium-sur-mesure-neuville-sur-saone',
