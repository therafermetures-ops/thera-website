...
export const metadata: Metadata = {
  title: 'Pergola Bioclimatique Design Cebel Belleville-en-Beaujolais — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Belleville-en-Beaujolais : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans le Beaujolais et le Rhône (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/pergola-bioclimatique-sur-mesure-belleville-en-beaujolais' },
  openGraph: {
    title: 'Pergola Bioclimatique Design Cebel Belleville-en-Beaujolais | THERA Fermetures',
    description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Belleville-en-Beaujolais : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans le Beaujolais et le Rhône (69).',
    images: [{ url: '/images/pergolas/pergola-villefranche.jpg', width: 1200, height: 630, alt: 'Pergola Bioclimatique Belleville-en-Beaujolais' }],
  },
}
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      ...
      heroImageAlt="Pergola bioclimatique motorisée a Belleville-en-Beaujolais par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquée par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Très appréciée des propriétaires de Belleville-en-Beaujolais.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement intégrée sans vis apparente. Ideale pour les proprietes de Belleville-en-Beaujolais, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
      ...
      showAdvantages={false}
            seoText="Entreprise Thera Fermetures : vente et installation de pergola bioclimatique design sur mesure à Belleville-en-Beaujolais et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
            heroH1="Pergola Bioclimatique Belleville-en-Beaujolais — Installation Sur Mesure par THERA Fermetures"
