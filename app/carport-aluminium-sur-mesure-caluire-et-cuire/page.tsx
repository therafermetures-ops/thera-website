...
export const metadata: Metadata = {
  title: 'Entreprise Carport Aluminium Caluire-et-Cuire — Installateur Local | THERA Fermetures',
  description: 'Carport aluminium Caluire-et-Cuire par THERA Fermetures. Commune lyonnaise, abri voiture design premium, motorisé. Devis gratuit sous 24h.',
  ...
  return (
    <ProductTemplate
      ...
      seoText="Entreprise Thera Fermetures : vente et installation de carport aluminium sur mesure à Caluire-et-Cuire et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
            heroH1="Vente et installation de carport aluminium moderne et sur mesure à Caluire-et-Cuire"
