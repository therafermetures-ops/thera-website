...
export const metadata: Metadata = {
  title: 'Portail Aluminium Motorisé Anse — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de portails aluminium motorisés sur mesure à Anse : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans le Beaujolais et le Rhône (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/portail-aluminium-sur-mesure-anse' },
  openGraph: {
    title: 'Portail Aluminium Motorisé Anse | THERA Fermetures',
    description: 'Installateur de portails aluminium motorisés sur mesure à Anse : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans le Beaujolais et le Rhône (69).',
    images: [{ url: '/images/portails/portail-arnas.jpg', width: 1200, height: 630, alt: 'Portail Aluminium Anse' }],
  },
}
...
export default function PortailPage() {
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "Le portail coulissant s'ouvre en glissant latéralement. Ideal pour les entrées etroites ou les allées en pente, il est disponible sur rail ou autoportant. Solution robuste pour les proprietes de Anse.",
          specs: [
        ...
        },
        {
          ...
          description: "Le portail battant s'ouvre comme une porte classique, en 1 ou 2 vantaux. Elegant et intemporel, il s'adapté parfaitement a tous les styles architecturaux. Motorisation totalement invisible. Très apprécié des propriétaires de Anse.",
          specs: [
      ...
      heroH1="Portail Aluminium Anse — Installation Sur Mesure par THERA Fermetures"
