...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Portail Aluminium sur Mesure Anse — THERA Fermetures',
    description: 'Portails aluminium sur mesure a Anse. Devis gratuit.',
      ...
      variants={[
        {
          ...
          description: "Le portail coulissant s'ouvre en glissant lateralement. Ideal pour les entrees etroites ou les allees en pente, il est disponible sur rail ou autoportant. Solution robuste pour les proprietes de Anse.",
          specs: [
        ...
        },
        {
          ...
          description: "Le portail battant s'ouvre comme une porte classique, en 1 ou 2 vantaux. Elegant et intemporel, il s'adapte parfaitement a tous les styles architecturaux. Motorisation totalement invisible. Tres apprecie des proprietaires de Anse.",
          specs: [
