...
export const metadata: Metadata = {
  title: 'Carport Aluminium Lozanne — Devis Gratuit, Abri Voiture Sur Mesure | THERA Fermetures',
  description: 'Installateur de carports aluminium et abris de voiture sur mesure à Lozanne : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans la vallée de l\'Azergues (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/carport-aluminium-sur-mesure-lozanne' },
  openGraph: {
    title: 'Carport Aluminium Lozanne | THERA Fermetures',
    description: 'Installateur de carports aluminium et abris de voiture sur mesure à Lozanne : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans la vallée de l\'Azergues (69).',
    images: [{ url: '/images/carports/carport-villefranche.jpg', width: 1200, height: 630, alt: 'Carport Aluminium Lozanne' }],
  },
}
...
export default function CarportPage() {
  return (
    <ProductTemplate
      ...
      seoText="Entreprise Thera Fermetures : vente et installation de carport aluminium sur mesure à Lozanne et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
            heroH1="Carport Aluminium Lozanne — Abri Voiture Sur Mesure par THERA Fermetures"
            ctaText="Obtenir mon devis carport a Lozanne"
      structuredData={{
