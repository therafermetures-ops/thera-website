...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Protection voitures sur mesure a Lozanne. Devis gratuit.',
    images: [{ url: '/images/carports/carport-claustra.png', width: 1200, height: 630, alt: 'Carport aluminium Lozanne' }],
  },
}
  ...
  return (
    <ProductTemplate
      ...
      seoText="Entreprise Thera Fermetures : vente et installation de carport aluminium sur mesure à Lozanne et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
            heroH1="Vente et installation de carport aluminium moderne et sur mesure à Lozanne"
