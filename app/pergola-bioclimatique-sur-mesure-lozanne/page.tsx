...
export const metadata: Metadata = {
  title: 'Entreprise Pergola Bioclimatique Lozanne — Installateur Local | THERA Fermetures',
  description: 'Pergola bioclimatique Lozanne par THERA Fermetures. Voisin de Chasselay, intervention rapide, fabrication française. Devis gratuit.',
  ...
  openGraph: {
    ...
    images: [{ url: '/images/pergolas/pergola-bioclimatique.jpg', width: 1200, height: 630, alt: 'Pergola bioclimatique Lozanne' }],
  },
}
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      ...
      heroImageAlt="Pergola bioclimatique motorisee a Lozanne par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquee par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Tres appreciee des proprietaires de Lozanne.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement integree sans vis apparente. Ideale pour les proprietes de Lozanne, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
