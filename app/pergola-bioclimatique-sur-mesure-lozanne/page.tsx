...
export const metadata: Metadata = {
  title: 'Pergola Bioclimatique Design Cebel Lozanne — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Lozanne : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans la vallée de l\'Azergues (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/pergola-bioclimatique-sur-mesure-lozanne' },
  openGraph: {
    title: 'Pergola Bioclimatique Design Cebel Lozanne | THERA Fermetures',
    description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Lozanne : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans la vallée de l\'Azergues (69).',
    images: [{ url: '/images/pergolas/pergola-villefranche.jpg', width: 1200, height: 630, alt: 'Pergola Bioclimatique Lozanne' }],
  },
}
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      title="Pergolas Bioclimatiques à Lozanne"
      subtitle="Terrasses motorisées Carat, Elements et VizVersa — commune voisine de Chasselay, intervention rapide"
      description="Commune directement voisine de nos ateliers à Chasselay, Lozanne bénéficie de délais d'intervention exceptionnels pour l'installation de pergolas bioclimatiques. THERA Fermetures y équipe régulièrement des terrasses avec des pergolas à lames orientables motorisées, adaptées aux jardins du Beaujolais. Visite sur site et devis sous 24h garantis."
      heroImage="/images/pergolas/pergola-bioclimatique.jpg"
      heroImageAlt="Pergola bioclimatique motorisée a Lozanne par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquée par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Très appréciée des propriétaires de Lozanne.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement intégrée sans vis apparente. Ideale pour les proprietes de Lozanne, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
      ...
      showAdvantages={false}
            ...
            heroH1="Pergola Bioclimatique Lozanne — Installation Sur Mesure par THERA Fermetures"
            ctaText="Obtenir mon devis pergola a Lozanne"
      structuredData={{
        '@context': 'https://schema.org',
        '@type': 'LocalBusiness',
        name: 'THERA Fermetures',
        description: 'Installateur de pergolas bioclimatiques sur mesure à Lozanne. Lames orientables motorisées, fabrication française. Devis gratuit.',
        url: 'https://thera-fermetures.fr/pergola-bioclimatique-sur-mesure-lozanne',
