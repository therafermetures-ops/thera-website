...
export const metadata: Metadata = {
  title: 'Carport Aluminium Trévoux — Devis Gratuit, Abri Voiture Sur Mesure | THERA Fermetures',
  description: 'Installateur de carports aluminium et abris de voiture sur mesure à Trévoux : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
  alternates: { canonical: 'https://thera-fermetures.fr/carport-aluminium-sur-mesure-trevoux' },
  openGraph: {
    title: 'Carport Aluminium Trévoux | THERA Fermetures',
    description: 'Installateur de carports aluminium et abris de voiture sur mesure à Trévoux : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
    images: [{ url: '/images/carports/carport-villefranche.jpg', width: 1200, height: 630, alt: 'Carport Aluminium Trévoux' }],
  },
}
  ...
  return (
    <ProductTemplate
      ...
      seoText="Entreprise Thera Fermetures : vente et installation de carport aluminium sur mesure à Trévoux et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
            heroH1="Carport Aluminium Trévoux — Abri Voiture Sur Mesure par THERA Fermetures"
