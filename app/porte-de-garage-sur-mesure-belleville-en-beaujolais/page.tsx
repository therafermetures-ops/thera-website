...
export const metadata: Metadata = {
  title: 'Porte de Garage sur Mesure Belleville-en-Beaujolais | THERA Fermetures',
  description: 'Portes de garage sectionnelles motorisees a Belleville-en-Beaujolais. Installation par THERA Fermetures. Devis gratuit.',
  keywords: ['porte de garage Belleville-en-Beaujolais', 'porte garage sectionnelle Beaujolais', 'porte garage motorisee Rhône (69)'],
  alternates: { canonical: 'https://thera-fermetures.fr/porte-de-garage-sur-mesure-belleville-en-beaujolais' },
  openGraph: {
    title: 'Porte de Garage sur Mesure Belleville-en-Beaujolais — THERA Fermetures',
    description: 'Portes de garage sectionnelles motorisees a Belleville-en-Beaujolais. Devis gratuit.',
    images: [{ url: '/images/portes-garage/porte-garage-villefranche.jpg', width: 1200, height: 630, alt: 'Porte de garage Belleville-en-Beaujolais' }],
  },
}
...
export default function PorteDeGaragePage() {
  return (
    <ProductTemplate
      title="Portes de Garage sur Mesure a Belleville-en-Beaujolais"
      subtitle="Sectionnelles, enroulables ou battantes — motorisees, isolees, fabriquees sur mesure a Belleville-en-Beaujolais et alentours"
      description="THERA Fermetures concoit et installe des portes de garage sur mesure a Belleville-en-Beaujolais depuis 2015. Nos portes sectionnelles motorisees offrent securite maximale, isolation thermique renforcee et un design adapte a votre facade. Motorisation Somfy silencieuse, +300 coloris, garantie 5 ans."
      heroImage="/images/portes-garage/porte-garage-villefranche.jpg"
      heroImageAlt="Porte de garage sectionnelle motorisee installee a Belleville-en-Beaujolais par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La porte sectionnelle 40mm est notre modele standard, ideal pour la majorite des garages residentiels. Elle s'ouvre verticalement le long du plafond, economisant ainsi l'espace devant et a l'interieur du garage. Tres apprecee des proprietaires de Belleville-en-Beaujolais.",
          specs: [
      ...
      advantages={[
        ...
        { icon: '', title: 'Installation rapide', text: 'Pose professionnelle en une demi-journee. Nos techniciens interviennent a Belleville-en-Beaujolais et dans tout le Beaujolais.' },
      ...
      structuredData={{
        ...
        '@type': 'Service',
        name: 'Porte de Garage sur Mesure a Belleville-en-Beaujolais',
        description: 'Portes de garage sectionnelles et motorisees fabriquees sur mesure a Belleville-en-Beaujolais.',
