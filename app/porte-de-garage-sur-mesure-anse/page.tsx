...
export const metadata: Metadata = {
  title: 'Porte de Garage Motorisée Anse — Devis Gratuit, Sectionnelle & Enroulable Sur Mesure | THERA Fermetures',
  description: 'Installateur de portes de garage motorisées sur mesure à Anse : sectionnelle Somfy, enroulable compacte, isolation 60mm. Devis gratuit par THERA Fermetures dans le Beaujolais et le Rhône (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/porte-de-garage-sur-mesure-anse' },
  openGraph: {
    title: 'Porte de Garage Motorisée Anse | THERA Fermetures',
    description: 'Installateur de portes de garage motorisées sur mesure à Anse : sectionnelle Somfy, enroulable compacte, isolation 60mm. Devis gratuit par THERA Fermetures dans le Beaujolais et le Rhône (69).',
...
export default function PorteDeGaragePage() {
  return (
    <ProductTemplate
      ...
      subtitle="Sectionnelles, enroulables ou battantes — motorisées, isolees, fabriquées sur mesure a Anse et alentours"
      description="THERA Fermetures concoit et installe des portes de garage sur mesure a Anse depuis 2015. Nos portes sectionnelles motorisées offrent sécurité maximale, isolation thermique renforcée et un design adapté a votre facade. Motorisation Somfy silencieuse, +300 coloris, garantie 5 ans."
      heroImage="/images/portes-garage/porte-garage-villefranche.jpg"
      heroImageAlt="Porte de garage sectionnelle motorisée installée a Anse par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La porte sectionnelle 40mm est notre modele standard, idéal pour la majorite des garages residentiels. Elle s'ouvre verticalement le long du plafond, economisant ainsi l'espace devant et a l'intérieur du garage. Très apprecee des propriétaires de Anse.",
          specs: [
      ...
      structuredData={{
        ...
        description: 'Portes de garage sectionnelles et motorisées fabriquées sur mesure a Anse.',
