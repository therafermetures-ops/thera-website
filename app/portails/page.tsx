...
export const metadata: Metadata = {
  title: 'Portails Aluminium sur Mesure - Coulissant, Battant, Autoportant | THERA Fermetures',
  description: 'Portails aluminium battants, coulissants et autoportants sur mesure. Motorisation Somfy, +300 coloris, garantie 10 ans. Installation Beaujolais & Rhône. Devis gratuit 24h.',
  ...
  openGraph: {
    title: 'Portails Aluminium — Coulissant, Battant, Autoportant | THERA Fermetures',
    description: 'Portails aluminium sur mesure motorisés. +300 coloris, fabrication française, garantie 10 ans. Devis gratuit 24h.',
...
export default function PortailsPage() {
  return (
    <ProductTemplate
      title="Portails Aluminium sur Mesure"
      subtitle="Coulissants, battants ou autoportants — fabriqués en France, installés par nos équipes dans tout le Beaujolais"
      description="Les portails aluminium THERA Fermetures combinent design contemporain, sécurité maximale et durabilité exceptionnelle. Chaque portail est fabriqué sur mesure à partir d'aluminium extrudé de première qualité, non recyclé, avec plus de 300 coloris disponibles. Motorisation Somfy ou BFT en option pour un accès ultra-pratique au quotidien."
