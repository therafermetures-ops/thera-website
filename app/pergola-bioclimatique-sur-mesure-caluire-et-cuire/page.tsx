...
export const metadata: Metadata = {
  title: 'Pergola Bioclimatique Design Cebel Caluire-et-Cuire — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Caluire-et-Cuire : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans la métropole de Lyon (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/pergola-bioclimatique-sur-mesure-caluire-et-cuire' },
  openGraph: {
    title: 'Pergola Bioclimatique Design Cebel Caluire-et-Cuire | THERA Fermetures',
    description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Caluire-et-Cuire : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans la métropole de Lyon (69).',
    images: [{ url: '/images/pergolas/pergola-villefranche.jpg', width: 1200, height: 630, alt: 'Pergola Bioclimatique Caluire-et-Cuire' }],
  },
}
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      ...
      description="Commune lyonnaise à forte densité, Caluire-et-Cuire présente des terrasses souvent réduites pour lesquelles THERA Fermetures propose des pergolas bioclimatiques compactes et design. Nos solutions sur mesure s'adaptént aux contraintes urbaines tout en maximisant l'espace de vie extérieur. Matériaux aluminium première qualité pour une intégration parfaite à l'architecture locale."
      heroImage="/images/pergolas/pergola-bioclimatique.jpg"
      heroImageAlt="Pergola bioclimatique motorisée a Caluire-et-Cuire par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquée par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Très appréciée des propriétaires de Caluire-et-Cuire.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement intégrée sans vis apparente. Ideale pour les proprietes de Caluire-et-Cuire, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
      ...
      showAdvantages={false}
            seoText="Entreprise Thera Fermetures : vente et installation de pergola bioclimatique design sur mesure à Caluire-et-Cuire et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
            heroH1="Pergola Bioclimatique Caluire-et-Cuire — Installation Sur Mesure par THERA Fermetures"
            ctaText="Obtenir mon devis pergola a Caluire-et-Cuire"
      structuredData={{
