...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/images/pergolas/pergola-bioclimatique.jpg', width: 1200, height: 630, alt: 'Pergola bioclimatique Caluire-et-Cuire' }],
  },
}
  ...
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquee par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Tres appreciee des proprietaires de Caluire-et-Cuire.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement integree sans vis apparente. Ideale pour les proprietes de Caluire-et-Cuire, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
      ...
      showAdvantages={false}
            ...
            heroH1="Vente et installation de pergola bioclimatique moderne design et sur mesure à Caluire-et-Cuire"
