...
export const metadata: Metadata = {
  title: 'Carport Aluminium Arnas — Devis Gratuit, Abri Voiture Sur Mesure | THERA Fermetures',
  description: 'Installateur de carports aluminium et abris de voiture sur mesure à Arnas : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans le Beaujolais et le Rhône (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/carport-aluminium-sur-mesure-arnas' },
  openGraph: {
    title: 'Carport Aluminium Arnas | THERA Fermetures',
    description: 'Installateur de carports aluminium et abris de voiture sur mesure à Arnas : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans le Beaujolais et le Rhône (69).',
    images: [{ url: '/images/carports/carport-villefranche.jpg', width: 1200, height: 630, alt: 'Carport Aluminium Arnas' }],
  },
}
...
export default function CarportPage() {
  return (
    <ProductTemplate
      ...
      heroH1="Carport Aluminium Arnas — Abri Voiture Sur Mesure par THERA Fermetures"
