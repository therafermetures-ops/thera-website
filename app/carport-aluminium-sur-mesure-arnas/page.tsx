...
export const metadata: Metadata = {
  ...
  description: 'Carports aluminium sur mesure a Arnas pour 1 a 4 voitures. Design epure, entretien zero, fabrication francaise. Devis gratuit.',
  ...
  return (
    <ProductTemplate
      ...
      structuredData={{
        ...
        description: 'Specialiste carports aluminium a Arnas depuis 2015.',
