...
export default function PortailPage() {
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "Le portail coulissant s'ouvre en glissant lateralement. Ideal pour les entrees etroites ou les allees en pente, il est disponible sur rail ou autoportant. Solution robuste pour les proprietes de Caluire-et-Cuire.",
          specs: [
        ...
        },
        {
          ...
          description: "Le portail battant s'ouvre comme une porte classique, en 1 ou 2 vantaux. Elegant et intemporel, il s'adapte parfaitement a tous les styles architecturaux. Motorisation totalement invisible. Tres apprecie des proprietaires de Caluire-et-Cuire.",
          specs: [
      ...
      heroH1="Vente et installation de portails aluminium moderne et sur mesure à Caluire-et-Cuire"
