...
export const metadata: Metadata = {
  title: 'Portail Aluminium Motorisé Caluire-et-Cuire — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de portails aluminium motorisés sur mesure à Caluire-et-Cuire : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans la métropole de Lyon (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/portail-aluminium-sur-mesure-caluire-et-cuire' },
  openGraph: {
    title: 'Portail Aluminium Motorisé Caluire-et-Cuire | THERA Fermetures',
    description: 'Installateur de portails aluminium motorisés sur mesure à Caluire-et-Cuire : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans la métropole de Lyon (69).',
    images: [{ url: '/images/portails/portail-arnas.jpg', width: 1200, height: 630, alt: 'Portail Aluminium Caluire-et-Cuire' }],
  },
}
...
export default function PortailPage() {
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "Le portail coulissant s'ouvre en glissant latéralement. Ideal pour les entrées etroites ou les allées en pente, il est disponible sur rail ou autoportant. Solution robuste pour les proprietes de Caluire-et-Cuire.",
          specs: [
        ...
        },
        {
          ...
          description: "Le portail battant s'ouvre comme une porte classique, en 1 ou 2 vantaux. Elegant et intemporel, il s'adapté parfaitement a tous les styles architecturaux. Motorisation totalement invisible. Très apprécié des propriétaires de Caluire-et-Cuire.",
          specs: [
      ...
      seoText="Entreprise Thera Fermetures : vente et installation de portail aluminium sur mesure à Caluire-et-Cuire et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
      heroH1="Portail Aluminium Caluire-et-Cuire — Installation Sur Mesure par THERA Fermetures"
      ctaText="Obtenir mon devis portail a Caluire-et-Cuire"
      structuredData={{
