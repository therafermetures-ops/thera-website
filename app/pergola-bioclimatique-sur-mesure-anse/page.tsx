...
export const metadata: Metadata = {
  title: 'Pergola Bioclimatique sur Mesure Anse | THERA Fermetures',
  description: 'Pergolas bioclimatiques motorisees a Anse. Lames orientables, capteur pluie, LED integree. Expert depuis 2015, fabrication francaise. Devis gratuit.',
  keywords: ['pergola bioclimatique Anse', 'pergola motorisee Anse', 'terrasse couverte Rhône (69)'],
  alternates: { canonical: 'https://thera-fermetures.fr/pergola-bioclimatique-sur-mesure-anse' },
  openGraph: {
    title: 'Pergola Bioclimatique sur Mesure Anse — THERA Fermetures',
    description: 'Pergola motorisee sur mesure a Anse. Devis gratuit.',
    images: [{ url: '/images/pergolas/pergola-bioclimatique.jpg', width: 1200, height: 630, alt: 'Pergola bioclimatique Anse' }],
  },
}
  ...
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquee par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Tres appreciee des proprietaires de Anse.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement integree sans vis apparente. Ideale pour les proprietes de Anse, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
      ...
      structuredData={{
        ...
        description: 'Specialiste pergolas bioclimatiques a Anse depuis 2015.',
