...
export const metadata: Metadata = {
  title: 'Entreprise Pergola Bioclimatique Anse — Installateur Local | THERA Fermetures',
  description: 'Pergola bioclimatique Anse (69) par THERA Fermetures. Beaujolais, lames motorisées, sur mesure. Devis gratuit.',
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      ...
      heroH1="Vente et installation de pergola bioclimatique moderne design et sur mesure à Anse"
