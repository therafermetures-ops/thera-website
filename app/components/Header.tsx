...
const products = [
  {
    ...
    desc: 'Battants, coulissants, motorisés sur mesure',
    href: '/portails',
  ...
  },
  {
    ...
    desc: 'Lames orientables, motorisées, toutes saisons',
    href: '/pergolas',
  ...
  },
  {
    ...
    desc: 'Abri voiture sur mesure, design épuré',
    href: '/carports',
  ...
  },
  {
    ...
    desc: 'Clôtures et brise-vue, robustes et esthétiques',
    href: '/clotures',
  ...
  },
  {
    ...
    desc: 'Sectionnelle, enroulable, battante sur mesure',
...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50" style={{ boxShadow: '0 2px 20px rgba(0,0,0,0.12)' }}>
        ...
        <div className="bg-white border-b border-gray-100">
          <div className="container flex items-center justify-between py-2.5">
            ...
            <Link href="/" onClick={() => setIsOpen(false)} className="flex-shrink-0">
              ...
              />
              {/* Fallback texte (visible si PNG absent) */}
              <div className="logo-fallback hidden" aria-hidden="true">
                <span className="font-black text-2xl tracking-tight text-primary">THERA</span>
                <span className="font-black text-2xl tracking-tight text-dark ml-1">FERMETURES</span>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              >
                ...
                <div>
                  <div className="text-xs text-muted leading-none mb-0.5">Appelez-nous</div>
                  <div className="text-base font-black text-dark tracking-tight">04 74 64 91 65</div>
                </div>
              </a>
              ...
              <div className="flex items-center gap-3 border-l border-gray-100 pl-8">
                ...
                <div>
                  <div className="text-xs text-muted leading-none mb-0.5">Horaires</div>
                  <div className="text-sm font-bold text-dark">Lun–Ven 8h30–17h30</div>
                </div>
              </div>
              ...
              <Link
                href="/contact"
                className="btn-primary text-sm py-2.5 px-5 ml-2"
              >
                Devis Gratuit
                    ...
                    {products.map((p) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-bold text-dark text-sm group-hover/item:text-primary transition-colors truncate">{p.title}</p>
                          <p className="text-muted text-xs mt-0.5 leading-snug">{p.desc}</p>
                        </div>
                        <svg className="w-4 h-4 text-muted flex-shrink-0 opacity-0 group-hover/item:opacity-100 transition-all group-hover/item:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div className="flex flex-col h-full pt-28 pb-8 overflow-y-auto">
          <div className="container flex flex-col gap-1">
            <Link href="/" onClick={() => setIsOpen(false)} className="text-xl font-bold text-dark py-3 border-b border-gray-100 hover:text-primary transition-colors">
              Accueil
            </Link>
            ...
            <div className="border-b border-gray-100">
              <button
                ...
                className="w-full flex items-center justify-between text-xl font-bold text-dark py-3 hover:text-primary transition-colors"
              >
                Nos Produits
              ...
              {mobileProductsOpen && (
                <div className="pb-3 pl-2 grid grid-cols-1 gap-2">
                  {products.map((p) => (
                    <Link
                      key={p.href}
                      href={p.href}
                      onClick={() => setIsOpen(false)}
                      className="flex items-center gap-3 p-3 bg-light rounded-xl hover:bg-primary/10 transition-colors"
                    >
            ...
            <Link href="/realisations" onClick={() => setIsOpen(false)} className="text-xl font-bold text-dark py-3 border-b border-gray-100 hover:text-primary transition-colors">
              Réalisations
            </Link>
            <Link href="/a-propos" onClick={() => setIsOpen(false)} className="text-xl font-bold text-dark py-3 border-b border-gray-100 hover:text-primary transition-colors">
              À Propos
            </Link>
            <Link href="/contact" onClick={() => setIsOpen(false)} className="text-xl font-bold text-dark py-3 border-b border-gray-100 hover:text-primary transition-colors">
              Contact
            </Link>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <Link href="/contact" onClick={() => setIsOpen(false)} className="btn-primary justify-center py-4 text-lg rounded-xl">
            ...
            <div className="mt-6 flex flex-col gap-2">
              {['Devis gratuit sous 24h', 'Visite offerte à domicile', 'Fabrication française', '500+ réalisations'].map((t) => (
