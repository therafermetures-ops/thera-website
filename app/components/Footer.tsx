        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="https://www.thera-proaccess.fr/" target="_blank" rel="noopener noreferrer" className="group flex flex-col hover:text-primary transition-colors">
                  <span className="text-gray-200 text-sm font-semibold group-hover:text-primary transition-colors">Professionnel & Collectif</span>
                  <span className="text-gray-500 text-xs">Portails pro, barrières levantes</span>
                </a>
              </li>
            </ul>
          </div>
