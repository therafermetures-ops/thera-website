...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Pergola motorisee sur mesure a Neuville-sur-Saône. Devis gratuit.',
    images: [{ url: '/images/pergolas/pergola-bioclimatique.jpg', width: 1200, height: 630, alt: 'Pergola bioclimatique Neuville-sur-Saône' }],
  },
}
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquee par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Tres appreciee des proprietaires de Neuville-sur-Saône.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement integree sans vis apparente. Ideale pour les proprietes de Neuville-sur-Saône, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
      ...
      heroH1="Vente et installation de pergola bioclimatique moderne design et sur mesure à Neuville-sur-Saône"
