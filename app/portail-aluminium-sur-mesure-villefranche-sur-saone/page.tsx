...
export const metadata: Metadata = {
  title: 'Portail Aluminium Motorisé Villefranche-sur-Saône — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de portails aluminium motorisés sur mesure à Villefranche-sur-Saône : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans le Beaujolais et le Rhône (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/portail-aluminium-sur-mesure-villefranche-sur-saone' },
  openGraph: {
    title: 'Portail Aluminium Motorisé Villefranche-sur-Saône | THERA Fermetures',
    description: 'Installateur de portails aluminium motorisés sur mesure à Villefranche-sur-Saône : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans le Beaujolais et le Rhône (69).',
  ...
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "Le portail coulissant s'ouvre en glissant latéralement. Ideal pour les entrées etroites ou les allées en pente, il est disponible sur rail ou autoportant. Solution robuste pour les proprietes de Villefranche-sur-Saône.",
          specs: [
        ...
        },
        {
          ...
          description: "Le portail battant s'ouvre comme une porte classique, en 1 ou 2 vantaux. Elegant et intemporel, il s'adapté parfaitement a tous les styles architecturaux. Motorisation totalement invisible. Très apprécié des propriétaires de Villefranche-sur-Saône.",
          specs: [
      ...
      youtubeStart={22}
            ...
            heroH1="Portail Aluminium Villefranche-sur-Saône — Installation Sur Mesure par THERA Fermetures"
