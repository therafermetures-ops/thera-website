...
export const metadata: Metadata = {
  title: 'Carport Aluminium Jassans-Riottier — Devis Gratuit, Abri Voiture Sur Mesure | THERA Fermetures',
  description: 'Installateur de carports aluminium et abris de voiture sur mesure à Jassans-Riottier : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
  alternates: { canonical: 'https://thera-fermetures.fr/carport-aluminium-sur-mesure-jassans-riottier' },
  openGraph: {
    title: 'Carport Aluminium Jassans-Riottier | THERA Fermetures',
    description: 'Installateur de carports aluminium et abris de voiture sur mesure à Jassans-Riottier : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
    images: [{ url: '/images/carports/carport-villefranche.jpg', width: 1200, height: 630, alt: 'Carport Aluminium Jassans-Riottier' }],
  },
}
...
export default function CarportPage() {
  return (
    <ProductTemplate
      ...
      heroH1="Carport Aluminium Jassans-Riottier — Abri Voiture Sur Mesure par THERA Fermetures"
