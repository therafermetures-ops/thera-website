...
export const metadata: Metadata = {
  title: 'Porte de Garage sur Mesure Lozanne | THERA Fermetures',
  description: 'Portes de garage sectionnelles motorisees a Lozanne. Installation par THERA Fermetures. Devis gratuit.',
  keywords: ['porte de garage Lozanne', 'porte garage sectionnelle Lozanne', 'porte garage motorisee Rhône (69)'],
  alternates: { canonical: 'https://thera-fermetures.fr/porte-de-garage-sur-mesure-lozanne' },
  openGraph: {
    title: 'Porte de Garage sur Mesure Lozanne — THERA Fermetures',
    description: 'Portes de garage sectionnelles motorisees a Lozanne. Devis gratuit.',
...
export default function PorteDeGaragePage() {
  return (
    <ProductTemplate
      ...
      subtitle="Sectionnelles, enroulables ou battantes — motorisees, isolees, fabriquees sur mesure a Lozanne et alentours"
      description="THERA Fermetures concoit et installe des portes de garage sur mesure a Lozanne depuis 2015. Nos portes sectionnelles motorisees offrent securite maximale, isolation thermique renforcee et un design adapte a votre facade. Motorisation Somfy silencieuse, +300 coloris, garantie 5 ans."
      heroImage="/images/portes-garage/porte-garage-villefranche.jpg"
      heroImageAlt="Porte de garage sectionnelle motorisee installee a Lozanne par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La porte sectionnelle 40mm est notre modele standard, ideal pour la majorite des garages residentiels. Elle s'ouvre verticalement le long du plafond, economisant ainsi l'espace devant et a l'interieur du garage. Tres apprecee des proprietaires de Lozanne.",
          specs: [
      ...
      structuredData={{
        ...
        description: 'Portes de garage sectionnelles et motorisees fabriquees sur mesure a Lozanne.',
