...
export const metadata: Metadata = {
  title: 'Porte de Garage Motorisée Lozanne — Devis Gratuit, Sectionnelle & Enroulable Sur Mesure | THERA Fermetures',
  description: 'Installateur de portes de garage motorisées sur mesure à Lozanne : sectionnelle Somfy, enroulable compacte, isolation 60mm. Devis gratuit par THERA Fermetures dans la vallée de l\'Azergues (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/porte-de-garage-sur-mesure-lozanne' },
  openGraph: {
    title: 'Porte de Garage Motorisée Lozanne | THERA Fermetures',
    description: 'Installateur de portes de garage motorisées sur mesure à Lozanne : sectionnelle Somfy, enroulable compacte, isolation 60mm. Devis gratuit par THERA Fermetures dans la vallée de l\'Azergues (69).',
    images: [{ url: '/images/portes-garage/porte-garage-villefranche.jpg', width: 1200, height: 630, alt: 'Porte De Garage Lozanne' }],
  },
}
...
export default function PorteDeGaragePage() {
  return (
    <ProductTemplate
      title="Portes de Garage sur Mesure a Lozanne"
      subtitle="Sectionnelles, enroulables ou battantes — motorisées, isolees, fabriquées sur mesure a Lozanne et alentours"
      description="THERA Fermetures concoit et installe des portes de garage sur mesure a Lozanne depuis 2015. Nos portes sectionnelles motorisées offrent sécurité maximale, isolation thermique renforcée et un design adapté a votre facade. Motorisation Somfy silencieuse, +300 coloris, garantie 5 ans."
      heroImage="/images/portes-garage/porte-garage-villefranche.jpg"
      heroImageAlt="Porte de garage sectionnelle motorisée installée a Lozanne par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La porte sectionnelle 40mm est notre modele standard, idéal pour la majorite des garages residentiels. Elle s'ouvre verticalement le long du plafond, economisant ainsi l'espace devant et a l'intérieur du garage. Très apprecee des propriétaires de Lozanne.",
          specs: [
      ...
      advantages={[
        ...
        { icon: '', title: 'Installation rapide', text: 'Pose professionnelle en une demi-journee. Nos techniciens interviennent a Lozanne et dans tout le Beaujolais.' },
      ...
      heroH1="Vente et installation de porte de garage sectionnelle motorisée sur mesure à Lozanne"
      ctaText="Obtenir mon devis porte de garage a Lozanne"
      seoText="Entreprise Thera Fermetures : vente et installation de porte de garage sectionnelle sur mesure a Lozanne et alentours. Base a Chasselay entre Villefranche-sur-Saone et Limonest."
      structuredData={{
        '@context': 'https://schema.org',
        '@type': 'Service',
        name: 'Porte de Garage sur Mesure a Lozanne',
        description: 'Portes de garage sectionnelles et motorisées fabriquées sur mesure a Lozanne.',
