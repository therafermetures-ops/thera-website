...
export const metadata: Metadata = {
  title: 'Porte de Garage Motorisée Quincieux — Devis Gratuit, Sectionnelle & Enroulable Sur Mesure | THERA Fermetures',
  description: 'Installateur de portes de garage motorisées sur mesure à Quincieux : sectionnelle Somfy, enroulable compacte, isolation 60mm. Devis gratuit par THERA Fermetures dans le nord lyonnais (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/porte-de-garage-sur-mesure-quincieux' },
  openGraph: {
    title: 'Porte de Garage Motorisée Quincieux | THERA Fermetures',
    description: 'Installateur de portes de garage motorisées sur mesure à Quincieux : sectionnelle Somfy, enroulable compacte, isolation 60mm. Devis gratuit par THERA Fermetures dans le nord lyonnais (69).',
    images: [{ url: '/images/portes-garage/porte-garage-villefranche.jpg', width: 1200, height: 630, alt: 'Porte De Garage Quincieux' }],
  },
}
...
export default function PorteDeGaragePage() {
  return (
    <ProductTemplate
      title="Portes de Garage sur Mesure a Quincieux"
      subtitle="Sectionnelles, enroulables ou battantes — motorisées, isolees, fabriquées sur mesure a Quincieux et alentours"
      description="THERA Fermetures concoit et installe des portes de garage sur mesure a Quincieux depuis 2015. Nos portes sectionnelles motorisées offrent sécurité maximale, isolation thermique renforcée et un design adapté a votre facade. Motorisation Somfy silencieuse, +300 coloris, garantie 5 ans."
      heroImage="/images/portes-garage/porte-garage-villefranche.jpg"
      heroImageAlt="Porte de garage sectionnelle motorisée installée a Quincieux par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La porte sectionnelle 40mm est notre modele standard, idéal pour la majorite des garages residentiels. Elle s'ouvre verticalement le long du plafond, economisant ainsi l'espace devant et a l'intérieur du garage. Très apprecee des propriétaires de Quincieux.",
          specs: [
      ...
      advantages={[
        ...
        { icon: '', title: 'Installation rapide', text: 'Pose professionnelle en une demi-journee. Nos techniciens interviennent a Quincieux et dans tout le Beaujolais.' },
      ...
      heroH1="Vente et installation de porte de garage sectionnelle motorisée sur mesure à Quincieux"
      ctaText="Obtenir mon devis porte de garage a Quincieux"
      seoText="Entreprise Thera Fermetures : vente et installation de porte de garage sectionnelle sur mesure a Quincieux et alentours. Base a Chasselay entre Villefranche-sur-Saone et Limonest."
      structuredData={{
        '@context': 'https://schema.org',
        '@type': 'Service',
        name: 'Porte de Garage sur Mesure a Quincieux',
        description: 'Portes de garage sectionnelles et motorisées fabriquées sur mesure a Quincieux.',
