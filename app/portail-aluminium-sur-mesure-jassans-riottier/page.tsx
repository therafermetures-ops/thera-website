...
export const metadata: Metadata = {
  title: 'Portail Aluminium Motorisé Jassans-Riottier — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de portails aluminium motorisés sur mesure à Jassans-Riottier : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
  alternates: { canonical: 'https://thera-fermetures.fr/portail-aluminium-sur-mesure-jassans-riottier' },
  openGraph: {
    title: 'Portail Aluminium Motorisé Jassans-Riottier | THERA Fermetures',
    description: 'Installateur de portails aluminium motorisés sur mesure à Jassans-Riottier : coulissants, battants et autoportants Somfy ou BFT. Devis gratuit, pose par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
...
export default function PortailPage() {
  return (
    <ProductTemplate
      ...
      variants={[
        {
          ...
          description: "Le portail coulissant s'ouvre en glissant latéralement. Ideal pour les entrées etroites ou les allées en pente, il est disponible sur rail ou autoportant. Solution robuste pour les proprietes de Jassans-Riottier.",
          specs: [
        ...
        },
        {
          ...
          description: "Le portail battant s'ouvre comme une porte classique, en 1 ou 2 vantaux. Elegant et intemporel, il s'adapté parfaitement a tous les styles architecturaux. Motorisation totalement invisible. Très apprécié des propriétaires de Jassans-Riottier.",
          specs: [
      ...
      heroH1="Portail Aluminium Jassans-Riottier — Installation Sur Mesure par THERA Fermetures"
