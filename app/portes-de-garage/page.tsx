...
export const metadata: Metadata = {
  title: 'Portes de Garage sur Mesure — Sectionnelle, Enroulable, Battante | THERA Fermetures',
  description: 'Portes de garage sectionnelles, enroulables et battantes sur mesure. Motorisation Somfy, isolation renforcée, +300 coloris. Installation Beaujolais & Rhône. Devis gratuit 24h.',
  ...
  openGraph: {
    title: 'Portes de Garage Sectionnelle, Enroulable & Battante — THERA Fermetures',
    description: 'Portes de garage sur mesure motorisées. Sectionnelle 40mm/60mm, enroulable, battante. Devis gratuit 24h.',
...
export default function PortesDeGaragePage() {
  return (
    <ProductTemplate
      ...
      subtitle="Sectionnelles, enroulables ou battantes — motorisées, isolées, fabriquées sur mesure dans tout le Beaujolais"
