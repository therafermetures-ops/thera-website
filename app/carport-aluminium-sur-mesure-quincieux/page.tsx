...
export const metadata: Metadata = {
  title: 'Carport Aluminium Quincieux — Devis Gratuit, Abri Voiture Sur Mesure | THERA Fermetures',
  description: 'Installateur de carports aluminium et abris de voiture sur mesure à Quincieux : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans le nord lyonnais (69).',
  alternates: { canonical: 'https://thera-fermetures.fr/carport-aluminium-sur-mesure-quincieux' },
  openGraph: {
    title: 'Carport Aluminium Quincieux | THERA Fermetures',
    description: 'Installateur de carports aluminium et abris de voiture sur mesure à Quincieux : adossé ou autoporté, toiture étanche. Devis gratuit, pose par THERA Fermetures dans le nord lyonnais (69).',
    images: [{ url: '/images/carports/carport-villefranche.jpg', width: 1200, height: 630, alt: 'Carport Aluminium Quincieux' }],
  },
}
...
export default function CarportPage() {
  return (
    <ProductTemplate
      ...
      heroH1="Carport Aluminium Quincieux — Abri Voiture Sur Mesure par THERA Fermetures"
