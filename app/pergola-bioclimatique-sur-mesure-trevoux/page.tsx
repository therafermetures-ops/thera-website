...
export const metadata: Metadata = {
  title: 'Pergola Bioclimatique Design Cebel Trévoux — Devis Gratuit, Installateur Sur Mesure | THERA Fermetures',
  description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Trévoux : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
  alternates: { canonical: 'https://thera-fermetures.fr/pergola-bioclimatique-sur-mesure-trevoux' },
  openGraph: {
    title: 'Pergola Bioclimatique Design Cebel Trévoux | THERA Fermetures',
    description: 'Installateur de pergolas bioclimatiques Cebel sur mesure à Trévoux : design moderne, lames orientables motorisées, LED intégrées. Devis gratuit par THERA Fermetures dans l\'Ain (01) et le Beaujolais.',
    images: [{ url: '/images/pergolas/pergola-villefranche.jpg', width: 1200, height: 630, alt: 'Pergola Bioclimatique Trévoux' }],
  },
}
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      title="Pergolas Bioclimatiques à Trévoux"
      subtitle="Terrasses motorisées Carat, Elements et VizVersa — préfecture de l'Ain au bord de la Saône"
      description="Préfecture de l'Ain au bord de la Saône, Trévoux bénéficie d'un ensoleillement favorable qui rend l'aménagement des terrasses particulièrement appréciable. THERA Fermetures y installe des pergolas bioclimatiques sur mesure permettant de profiter de l'extérieur quelle que soit la météo. Notre équipe traverse le Rhône depuis Chasselay pour intervenir en moins de 20 minutes."
      heroImage="/images/pergolas/pergola-bioclimatique.jpg"
      heroImageAlt="Pergola bioclimatique motorisée a Trévoux par THERA Fermetures"
      features={[
      ...
      variants={[
        {
          ...
          description: "La Pergola Carat est notre modele premium, labellisee Origine France Garantie et fabriquée par Cebel, entreprise implantee au sud de Lyon. Ses poteaux en forme de diamant lui conferent une finition originale et raffinee. Très appréciée des propriétaires de Trévoux.",
          specs: [
        ...
        },
        {
          ...
          description: "La Pergola Elements est notre modele accessible et haut de gamme. Poteaux avec chanfreins, quincaillerie entierement intégrée sans vis apparente. Ideale pour les proprietes de Trévoux, elle offre le meilleur rapport entre investissement et performance.",
          specs: [
      ...
      showAdvantages={false}
            seoText="Entreprise Thera Fermetures : vente et installation de pergola bioclimatique design sur mesure à Trévoux et alentours. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
            heroH1="Pergola Bioclimatique Trévoux — Installation Sur Mesure par THERA Fermetures"
            ctaText="Obtenir mon devis pergola a Trévoux"
      structuredData={{
        '@context': 'https://schema.org',
        '@type': 'LocalBusiness',
        name: 'THERA Fermetures',
        description: 'Installateur de pergolas bioclimatiques sur mesure à Trévoux. Lames orientables motorisées, fabrication française. Devis gratuit.',
        url: 'https://thera-fermetures.fr/pergola-bioclimatique-sur-mesure-trevoux',
