...
export const metadata: Metadata = {
  title: 'Entreprise Pergola Bioclimatique Quincieux — Installateur Local | THERA Fermetures',
  description: 'Pergola bioclimatique Quincieux par THERA Fermetures. Val de Saône, grandes terrasses, sur mesure. Devis gratuit.',
...
export default function PergolaPage() {
  return (
    <ProductTemplate
      ...
      heroH1="Vente et installation de pergola bioclimatique moderne design et sur mesure à Quincieux"
