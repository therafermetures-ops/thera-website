...
export default function PortailAcierPage() {
  return (
    <ProductTemplate
      ...
      seoText="Entreprise Thera Fermetures : vente et installation de portail acier sur mesure à Villefranche-sur-Saône. Basé à Chasselay entre Villefranche-sur-Saône et Limonest."
      showGalleryLink={false}
      structuredData={{
        '@context': 'https://schema.org',
        '@type': 'LocalBusiness',
        name: 'THERA Fermetures',
        description: 'Installateur de portails acier sur mesure à Villefranche-sur-Saône. Design unique, découpe laser. Devis gratuit.',
        url: 'https://thera-fermetures.fr/portail-acier-sur-mesure-villefranche-sur-saone',
